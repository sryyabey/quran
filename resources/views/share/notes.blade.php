...
<head>
  ...
  <meta name="description" content="{{ $share->user->name ?? 'Bir araştırmacı' }} tarafından paylaşılan Kur'an araştırma notları.">
  <meta property="og:title" content="{{ $share->title ?: "Kur'an Not Paylaşımı" }}">
  <meta property="og:description" content="{{ $share->user->name ?? 'Bir araştırmacı' }} tarafından paylaşılan Kur'an araştırma notları · Tadabbur">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Amiri:ital,wght@0,400;0,700;1,400&family=Lora:ital,wght@0,400;0,500;0,600;1,400&family=Cairo:wght@300;400;500;600;700&display=swap" rel="stylesheet">
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-emblem svg { width: 19px; height: 19px; }
    .brand-name {
    ...
    .share-badge i { font-size: 13px; color: var(--gold-mid); }
    ...
    .meta-item i { font-size: 14px; color: var(--teal-mid); }
    .meta-item strong { color: var(--text-mid); font-weight: 600; }
    .expiry-chip {
      display: inline-flex;
      align-items: center;
      gap: 5px;
    ...
    .stat-pill i { font-size: 15px; color: var(--teal-mid); }
    .stat-pill strong { color: var(--teal-dark); font-weight: 700; }
    ...
    .sura-title-group { flex: 1; position: relative; z-index: 1; }
    .sura-name {
      font-family: 'Cairo', sans-serif;
      font-size: 17px;
      font-weight: 700;
    ...
    .aya-block:first-child { border-top: none; }
    ...
    .note-type-badge.note     { background: #eff6ff; color: #1d4ed8; border: 1px solid #bfdbfe; }
    .note-type-badge.footnote { background: #fffbeb; color: #b45309; border: 1px solid #fde68a; }
    .note-type-badge.research { background: #f5f3ff; color: #6d28d9; border: 1px solid #ddd6fe; }
    ...
    .footer-logo strong { color: var(--teal-dark); }
    .footer-ayah {
      font-family: 'Amiri', serif;
      font-size: 17px;
      color: var(--text-light);
    ...
    /* ── Print ──────────────────────────────────────────────────────── */
    @media print {
      .topbanner, .share-badge, .stats-bar { display: none; }
      body { background: #fff; font-size: 12px; }
      .sura-header { background: #1a6b5a !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      .hero { background: #fff; padding-top: 0; }
      .sura-block { box-shadow: none; border: 1px solid #ccc; break-inside: avoid; }
      .arabic-text { background: #fafafa !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    }

    /* ── Responsive ─────────────────────────────────────────────────── */
    @media (max-width: 640px) {
      .hero-meta-row { gap: .75rem; }
      .topbanner-inner { flex-direction: column; align-items: flex-start; gap: .5rem; }
      .sura-header { flex-wrap: wrap; }
      .sura-count-chip { order: 3; }
  ...
  <div class="topbanner">
    <div class="topbanner-inner">
      <a href="#" class="brand">
        ...
        <div>
          <div class="brand-name">Kur'an Araştırma Merkezi</div>
  ...
  <div class="hero">
    <div class="hero-inner">
      <div class="hero-eyebrow">
        <span class="hero-eyebrow-chip"><i class="ti ti-notes" style="font-size:10px;margin-right:3px;"></i>Araştırma Notları</span>
      </div>
      ...
      <div style="margin-top:.9rem;">
        <span class="range-pill" style="display:inline-flex;align-items:center;gap:7px;font-family:'Cairo',sans-serif;font-size:12px;color:var(--teal-dark);background:var(--teal-light);border:1px solid rgba(45,155,132,.25);border-radius:10px;padding:5px 12px;">
                ...
                @foreach($ayaData['notes'] as $note)
                  ...
                  <div class="note-card">
                    ...
                    <div class="note-card-body">
                      ...
                      <div class="word-chip">
                        <span class="word-chip-label"><i class="ti ti-cursor-text" style="font-size:11px;margin-right:2px;"></i>İlgili kelime:</span>
                      ...
                      <div class="note-tags">
                        @foreach($note['tags'] as $tag)
                          <span class="note-tag"><i class="ti ti-tag" style="font-size:10px;"></i>{{ $tag }}</span>
                        @endforeach
                      </div>
                      @endif
                    </div>
  ...
  <div class="footer">
    <div class="footer-inner">
      <div class="footer-logo">
        Bu paylaşım <strong>Kur'an Araştırma Merkezi · Tadabbur</strong> aracılığıyla oluşturulmuştur.
      </div>
